...
if __name__ == '__main__':
    ...
    razvrscanje_isb_out()
    if os.path.getsize(os.getcwd() + '\\' + 'fedex.csv') != 0:
        fedex()
    if os.path.getsize(os.getcwd() + '\\' + 'isb_out.csv') != 0:
        isb_out()
    if os.path.getsize(os.getcwd() + '\\' + 'navadna.csv') != 0:
        navadna()
    if os.path.getsize(os.getcwd() + '\\' + 'private_individuals.csv') != 0:
        private_individual()
    # na koncu izbrisemo .csv datoteke ker smo jih ze razvrstili
    os.remove(os.getcwd() + '\\' + 'fedex.csv')
    os.remove(os.getcwd() + '\\' + 'isb_out.csv')
    os.remove(os.getcwd() + '\\' + 'navadna.csv')
